...
func TestSubscription(t *testing.T) {
	...
	gock.New("http://localhost:57493").
		...
		Reply(http.StatusOK).
		BodyString(`[{"status":"active","days_until_due": 7,"current_period_end":1571246262,"plan":{"id":"plan_12345","nickname":"Plan"}}]`)
